package com.wg.commons.generator.utils;

import com.wg.commons.generator.entity.ColumnEntity;
import com.wg.commons.generator.entity.TableEntity;
...
//        templates.add("template/index.vue.vm");
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("service.java.vm")) {
            return packagePath + "business/service/intf" + File.separator + className + "Service.java";
        }
        if (template.contains("impl.java.vm")) {
            return packagePath + "business/service/impl" + File.separator + className + "ServiceImpl.java";
        }
